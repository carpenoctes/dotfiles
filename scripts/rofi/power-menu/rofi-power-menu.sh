...
all=(logout reboot hibernate shutdown cancel)

# By default, show all (i.e., just copy the array)
show=("${all[@]}")
show=(logout reboot hibernate shutdown cancel)
...
actions[hibernate]="systemctl hybrid-sleep"
...
function write_message {
    ...
    then
        ...
        icon="<span font=\"${symbols_font}\" font_size=\"large\">$1</span>"
    fi
