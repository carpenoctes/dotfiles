...
post_commands=(
  ...
  #"killall swww"
  "waybar &"
  "swww img --transition-type=wipe --transition-fps 60 /home/saddaf/Pictures/desktop.jpg &"
  "nwg-look -a"
  "cd /home/saddaf/.config/dunst"
  "sh dunstmerge top-right"
  "kill $(pidof dunst)"
  #'for file in /home/saddaf/.config/nChain/links/*; do [ "$(basename "$file")" != "AmethystAria" ] && [ -f "$file" ] && filename=$(basename "$file") && filename="${filename^}" && notify-send -a "nChain" "Theme: $filename"; done'
